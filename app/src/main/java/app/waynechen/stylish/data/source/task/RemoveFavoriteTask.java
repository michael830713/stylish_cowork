 ...
 */
public class RemoveFavoriteTask extends AsyncTask<Void, Void, String> {
    ...
    public RemoveFavoriteTask(String token, long itemId, StylishDataSource.AvatarChangeCallback callback) {
        mErrorMessage = "";
        mToken = token;
        mItemId = itemId;
        mCallback = callback;
    ...
    protected String doInBackground(Void[] voids) {
        ...
        try {
            bean = StylishApiHelper.removeFavoriteItem(mToken, mItemId);
        } catch (IOException e) {
