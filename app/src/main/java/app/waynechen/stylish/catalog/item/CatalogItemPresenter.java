 ...
 */
public class CatalogItemPresenter implements CatalogItemContract.Presenter {

    private final StylishRepository mStylishRepository;
    private final CatalogItemContract.View mCatalogItemView;

    private boolean mLoadingData;

    public CatalogItemPresenter(
            @NonNull StylishRepository stylishRepository,
            @NonNull CatalogItemContract.View catalogItemView) {
